...
public class ProjectServiceImpl implements ProjectService {
    ...
    public List<ProjectDTO> listAllProjectDetails() {
        ...
        String preferredUsername = details.getKeycloakSecurityContext().getToken().getPreferredUsername();

        UserDTO currentUserDTO = userService.findByUserName(preferredUsername);
